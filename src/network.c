// Added some functions related to Gaussian YOLOv3
...
#include "gaussian_yolo_layer.h" //Gaussian_YOLOv3
...
char *get_layer_string(LAYER_TYPE a)
{
    switch(a){
        ...
        case YOLO:
            return "yolo";
        case GAUSSIAN_YOLO: //Gaussian_YOLOv3
...
int resize_network(network *net, int w, int h)
{
    ...
    for (i = 0; i < net->n; ++i){
        ...
        }else if(l.type == GAUSSIAN_YOLO){ //Gaussian_YOLOv3
...
int num_detections(network *net, float thresh)
{
    ...
    for(i = 0; i < net->n; ++i){
        ...
        if(l.type == GAUSSIAN_YOLO){ //Gaussian_YOLOv3
